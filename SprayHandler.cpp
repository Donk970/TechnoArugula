...
SprayValve :: SprayValve() {
  this->duration = 500;
  this->interval = 10000; // default interval until next valve should be set is ten seconds
}
...
SprayHandler :: SprayHandler(uint8_t valveAPin, uint8_t valveBPin, uint8_t valveCPin) {
  ...
  this->valveA.interval = 480000; //interval until valveA opens is 15 minutes
